...
//   final String listCompleted;

//   const Edittodo({required this.listId, required this.listTitle, required this.listDesc, required this.listCompleted});
...
//     isCompleted = widget.listCompleted == "true" ? true : false;
...
//     final url = Uri.parse('$apiUrl/update_todo');
...
//       // Get.back();
//       Get.offAll(Todolist());
//       showSnackBar("Edit Todo Completed");
//     } else {
//       showSnackBar("fail");
//     }
//   }
