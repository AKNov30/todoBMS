...
class _TodoListScreenState extends State<TodoListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(body: TextButton(onPressed: _logout, child: Text("log out")));
  }
}
...
//     // print('id: $userId');
//     final url = Uri.parse('$apiUrl/todo_list/$userId');
...
//       // if (responseData["code"] == "PROTOCOL_ENQUEUE_AFTER_FATAL_ERROR") {
//       //   await _fetchTodo();
//       //   print("123");
//       // }
...
//         // inspect(responseData);
//         setState(() {
//           todoList = responseData.map((data) => Lists.fromJson(data)).toList().cast<Lists>();
//         });
//         noData = false;
//       }
//       setState(() {
...
//     final url = Uri.parse('$apiUrl/delete_todo/$listId');
//     final headers = {'Content-Type': 'application/json', 'Authorization': 'Bearer 950b88051dc87fe3fcb0b4df25eee676'};
...
//   void showEditModal(int listId, String listTitle, String listDesc, String listCompleted) {
//     showModalBottomSheet(
//       context: context,
//       builder: (BuildContext context) {
//         return Container(
...
//                 InkWell(
//                   onTap: () async {
//                     await Get.to(() => Edittodo(listId: listId, listTitle: listTitle, listDesc: listDesc, listCompleted: listCompleted));
//                     await _loadUserData();
//                   },
//                   child: Row(
//                     mainAxisAlignment: MainAxisAlignment.spaceBetween,
...
//               ),
//               noData
//                   ? Center(child: Text("ยังไม่มีข้อมูล", style: GoogleFonts.outfit(fontSize: 16, color: Colors.grey)))
//                   : filteredTodoList.isEmpty
//                   ? Center(child: Text("ไม่พบข้อมูล", style: GoogleFonts.outfit(fontSize: 16, color: Colors.grey)))
//                   : ListView.builder(
//                     shrinkWrap: true,
...
//                       String formattedDate = DateFormat('hh:mm a - MM/dd/yy').format(todo.lastUpdate.toUtc().add(Duration(hours: 7)));
//                       return Padding(
...
//                                     child: InkWell(
//                                       child: Image.asset(todo.listCompleted == "true" ? "assets/images/check.png" : "assets/images/un_check.png"),
//                                     ),
//                                   ),
//                                   SizedBox(),
//                                   SizedBox(),
